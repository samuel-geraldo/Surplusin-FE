import { Edit, Search, LocateFixed } from 'lucide-react';
        ...
        <section className="shrink-0 rounded-[14px] bg-white" style={{ width: 632.5, height: 650, padding: '37px 30px' }}>
          <div className="flex items-center justify-between" style={{ marginBottom: 33 }}>
            <div className="flex items-center gap-3">
              <img
                src="/recipient_retailer icon/basic-icon/icon rumah.svg"
                alt=""
                aria-hidden="true"
            ...
            >
              <Edit className="size-[22px] fill-black" strokeWidth={2.1} />
            </button>
          </div>
